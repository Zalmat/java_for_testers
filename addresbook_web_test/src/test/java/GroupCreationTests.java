...
public class GroupCreationTests {
    ...
    public void setUp() {
        if (driver == null) {
            ...
            driver.manage().window().maximize(); //Пришлось отказаться от driver.manage().window().setSize(new Dimension(1920, 1080));
    ...
    public void CanCreateGroup() throws InterruptedException {
        ...
        driver.findElement(By.name("group_name")).sendKeys("Имя группы");
        driver.findElement(By.name("group_header")).click();
        driver.findElement(By.name("group_header")).sendKeys("Хидер группы");
        driver.findElement(By.name("group_footer")).click();
        driver.findElement(By.name("group_footer")).sendKeys("Футер группы");
